...
def define_img_size(size):
    ...
    img_size_dict = {(128): [128, 96], (160): [160, 120], (320): [320, 240],
        (480): [480, 360], (640): [640, 480], (1280): [1280, 960]}
    image_size = img_size_dict[size]
    feature_map_w_h_list_dict = {(128): [[16, 8, 4, 2], [12, 6, 3, 2]], (
        160): [[20, 10, 5, 3], [15, 8, 4, 2]], (320): [[40, 20, 10, 5], [30,
        15, 8, 4]], (480): [[60, 30, 15, 8], [45, 23, 12, 6]], (640): [[80,
        40, 20, 10], [60, 30, 15, 8]], (1280): [[160, 80, 40, 20], [120, 60,
        30, 15]]}
